        ...
        <div class="position-absolute fixed-navbar fixedNavbar">
            <div class="container img-one-container">
                <div class="social-media mt-2">
                    <div class="row justify-content-between">
                            ...
                            @if ($settings['contact_email'])
                                <div class="ms-4">
                                    <a href="mailto:{{ $settings['contact_email'] }}">
                                        ...
                                        <img src="{{ asset('website/imgs/icons/dark-mail.svg') }}" alt="mail-icon" class="img-fluid">
                                    </a>
                                </div>
                            @endif
                            @if ($settings['phone'])
                                <div>
                                    <a href="tel:{{ $settings['phone'] }}">
                                        ...
                                        <img src="{{ asset('website/imgs/icons/dark-phone.svg') }}" alt="phone-icon" class="img-fluid">
                                    </a>
                                </div>
                            @endif
                        </div>
                        <div
                            ...
                            <a class="dark-icon-1" href="{{ $settings['linkedin_link'] }}" target="_blank">
                                <img src="{{ asset('website/imgs/icons/dark-Linked-In.svg') }}" alt="icon">
                            </a>
                            @endif
                            @if ($settings['twitter_link'])
                                <a class="dark-icon-1" href="{{ $settings['twitter_link'] }}" target="_blank">
                                    <img src="{{ asset('website/imgs/icons/dark-icons8-twitterx 1.svg') }}" alt="icon">
                                </a>
                            @endif
                            @if ($settings['facebook_link'])
                                <a class="dark-icon-1" href="{{ $settings['facebook_link'] }}" target="_blank">
                                    <img src="{{ asset('website/imgs/icons/dark-Facebook.svg') }}" alt="icon">
                                </a>
                            @endif
                            @if ($settings['instagram_link'])
                                <a class="dark-icon-1" href="{{ $settings['instagram_link'] }}" target="_blank">
                                    <img src="{{ asset('website/imgs/icons/dark-Instagram.svg') }}" alt="icon">
                                </a>
                            @endif
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-expand-lg" id="headerBar">
                    ...
                    <a class="navbar-brand if-not-active-6  d-lg-none" href="website/{{ route('home') }}">
                        <img src="{{ asset('website/imgs/logo.png') }}" alt="logo">
                    </a>
                    <a class="navbar-brand if-not-active-5 d-lg-none" href="{{ route('home') }}">
                        <img src="{{ asset('website/imgs/icons/dark-logo.png') }}" alt="logo">
                    </a>
                    ...
                    <div class="collapse navbar-collapse d-lg-flex justify-content-center" id="navbarNav">
                        <ul class="navbar-nav text-center py-4 align-items-center">
                            <li class="nav-item">
                                <a class="nav-link nav-link-3" aria-current="page" href="{{ route('home') }}">الصفحة
                                    الرئيسية</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link nav-link-3" href="{{ route('website.about') }}">من نحن</a>
                            </li>
                            ...
                            <div class="text-center social-media-icons d-flex d-md-none">
                                ...
                                <a href="https://www.linkedin.com/company/slsalah-sa/" target="_blank">
                                    <img src="{{ asset('website/imgs/icons/Linked-In.svg') }}" alt="icon">
                                </a>
                                <a href="https://twitter.com/slsalah_sa" target="_blank">
                                    <img src="{{ asset('website/imgs/icons/icons8-twitterx 1.svg') }}" alt="icon">
                                </a>
                                <a href="https://www.facebook.com/Slsalah.sa" target="_blank">
                                    <img src="{{ asset('website/imgs/icons/Facebook.svg') }}" alt="icon">
                                </a>
                                <a href="https://www.instagram.com/slsalah_sa" target="_blank">
                                    <img src="{{ asset('website/imgs/icons/Instagram.svg') }}" alt="icon">
                                </a>
                            </div>
                        </ul>
                    </div>
                    <a class="navbar-brand if-not-active-6 aaaa" href="{{ route('home') }}">
                        <img src="{{ asset('website/imgs/logo.png') }}" alt="logo">
                    </a>
                    <a class="navbar-brand if-not-active-5 aaaa" href="{{ route('home') }}">
                        <img src="{{ asset('website/imgs/icons/dark-logo.png') }}" alt="logo">
                    </a>
                </nav>
            </div>
    ...
    <section id="info-gallery">
        <div class="container info-gallery-container">
            <div class="row gy-5 justify-content-between first-row">
                ...
                <div class="first-row-blog">
                    ...
                    <div class="first-row-blog-blog">
                        <span>{{ $article->writer_spaicality }}</span>
                    </div>
                </div>
            </div>
            <div class="row second-row gy-4">
                ...
                <p class="col-12 mb-0" data-aos="fade-down" data-aos-duration="1000">{!! $article->decription !!}</p>
            </div>
            <div class="row-three">
