...
Route::prefix('admin')->middleware(['auth','ActiveAccount'])->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::resource('project-gallery',BackendProjectGalleryController::class);
        ...
        Route::resource('consulting-requests',BackendConsultingRequestController::class);
        ...
        Route::get('mailing-list',[BackendMailingListController::class,'index'])->name('mailing-list.index');
